...
# Your code goes here ...
puts "What is the name of the store you would like to create"
store_name = $stdin.gets.chomp;
puts "You would like to create the store: #{store_name}"
store = Store.create(name: "#{store_name}")
error = store.errors.messages
puts "Could not create your store because: #{error}"
